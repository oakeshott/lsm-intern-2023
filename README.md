...
python quantize_with_package.py --save_dir ../saved_models/nn/binary-classification/16x16 --filename mlp_pktflw.th --num_bins 128 --calib-method histogram --is-binary # Quantization
